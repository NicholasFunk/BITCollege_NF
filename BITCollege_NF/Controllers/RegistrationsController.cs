...
namespace BITCollege_NF.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RegstrationId,StudentId,CourseId,RegistrationNumber,RegistrationDate,Grade,Notes")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RegstrationId,StudentId,CourseId,RegistrationNumber,RegistrationDate,Grade,Notes")] Registration registration)
        {
            if (ModelState.IsValid)
            {
